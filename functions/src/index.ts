...
exports.getData = functions.https.onRequest(async (req: any, res: any) => {
    const id = req.query.id;
    const url = await getData(id);
...
getData('teagle').then(str => console.log(str)).catch(err => console.log(err)); 
